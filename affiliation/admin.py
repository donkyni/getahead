...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = (
            'nom_d_utilisateur', 'nom_du_parent', 'nom', 'prenom', 'adresse',
            'pays_de_residence', 'telephone', 'groupe',
            'avatar', 'sexe', 'profil', 'gam', 'point', 'stock_point', 'palier', 'poste', 'is_admin')
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': (
            ...
            'pays_de_residence', 'telephone', 'groupe',
            'avatar', 'sexe', 'profil', 'point', 'stock_point', 'palier', 'poste',)}),
    ...
    add_fieldsets = (
        (None, {
            ...
            'fields': (
                'nom_d_utilisateur', 'nom_du_parent', 'nom', 'prenom', 'adresse',
            'pays_de_residence', 'telephone', 'groupe',
            'avatar', 'sexe', 'profil', 'point', 'stock_point', 'palier', 'poste', 'password'),
        }),
    )
