# Generated by Django 3.1.1 on 2020-10-30 01:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom_du_parrain', models.CharField(max_length=255, null=True)),
                ('prenom_du_parrain', models.CharField(max_length=255, null=True)),
                ('archive', models.BooleanField(default=False)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pied_droite', models.BooleanField(default=False, null=True)),
