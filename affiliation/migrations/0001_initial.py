# Generated by Django 3.1.1 on 2020-11-09 12:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom_d_utilisateur', models.CharField(help_text="Le nom d'utilisateur servira à se connecter à la plateforme, également pour parrainer un membre. Ex. 228DS000000001", max_length=255, null=True, unique=True)),
                ...
                ('gam', models.PositiveSmallIntegerField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('aucun', models.BooleanField(default=False, null=True)),
